    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.gridContainer}>
                ...
                <View style={styles.row}>
                    <TouchableOpacity
                        onPress={() => router.push("/addfile")} // Changed to push
                        style={styles.cardContainer}
                        accessibilityLabel="Navigate to add lesson Screen"
                    >
                        <Ionicons name="book-outline" size={40} color="#8BC34A" />
                        <Text style={styles.cardLabel}>kongeroho amsomo</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                ...
                <View style={styles.row}>
                    ...
                    >
                        <MaterialCommunityIcons name="chat-outline" size={40} color="#8BC34A" />
                        <Text style={styles.cardLabel}>Ganiriza Umuhinzi</Text>
                    </TouchableOpacity>
